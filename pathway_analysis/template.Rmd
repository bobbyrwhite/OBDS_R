...
all_genes_df <- read_csv("/project/obds/bwhite/base_r/projects/DEseq2_tutorial/CD8_vs_CD4_DE_results_lfcshrinkage_allgenes.csv")

# check its dimensions - and look at the top of the file -> what does this tell us about our table? 

rownames(all_genes_df)
dim(all_genes_df)
head(all_genes_df)
...
# numbers do not matc but continuing anyway
...
all_gene_ids <- all_genes_df_filtered %>%
  pull(gene_id)
